...
calendar[1][1].format(jalaali?" jYYYY":" YYYY");var localMonth=jalaali?'jMonth':'month',localYear=jalaali?'jYear':'year';if(this.showDropdowns){var currentMonth=calendar[1][1][localMonth]();var currentYear=calendar[1][1][localYear]();var maxYear=(maxDate&&maxDate[localYear]())||(currentYear+ 5);var minYear=(minDate&&minDate[localYear]())||(currentYear- 50);var inMinYear=currentYear==minYear;var inMaxYear=currentYear==maxYear;
